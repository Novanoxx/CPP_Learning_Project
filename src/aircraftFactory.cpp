...
void aircraftFactory::init_aircraft_types()
{
    ...
    aircraft_types[2] = new AircraftType { .03f, .06f, .03f, MediaPath { "concorde_af.png" } };
}

void aircraftFactory::add_flight_number(const std::string& number)
{
    setAircrafts.emplace(number);
}